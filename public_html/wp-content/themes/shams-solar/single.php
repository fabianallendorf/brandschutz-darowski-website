...
<div class="container">
	<div class="row">
		<?php
	    $layout_settings = get_theme_mod( 'shams_solar_layout_settings', __('Right Sidebar','shams-solar') );
			...
			<div class="col-lg-8 col-md-8">
				...
				while ( have_posts() ) : the_post(); 
					...
					the_post_navigation( array(
						'prev_text' => '<span class="screen-reader-text">' . __( 'Previous Post', 'shams-solar' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Previous', 'shams-solar' ) . '</span>',
						'next_text' => '<span class="screen-reader-text">' . __( 'Next Post', 'shams-solar' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Next', 'shams-solar' ) . '</span>',
					) );
