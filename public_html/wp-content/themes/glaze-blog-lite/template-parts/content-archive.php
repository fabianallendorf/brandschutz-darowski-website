 ...
 */
$display_featured_image = glaze_blog_lite_get_option( 'archive_display_feat_img' );
$display_date = glaze_blog_lite_get_option( 'archive_display_date' );
$display_categories = glaze_blog_lite_get_option( 'archive_display_cats' );
$display_author = glaze_blog_lite_get_option( 'archive_display_author' );
$display_comments_no = glaze_blog_lite_get_option( 'archive_display_comments_no' );
?>
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="bottom-wrap">
        ...
        <?php
        if( $display_author == true || $display_comments_no == true || glaze_blog_lite_social_share() != false ) {
            ?>
