...
if( ! class_exists( 'Glaze_Blog_Lite_Social_Widget' ) ) {

    class Glaze_Blog_Lite_Social_Widget extends WP_Widget {
 
        function __construct() { 

            parent::__construct(
                'glaze-blog-lite-social-widget',  // Widget ID
                esc_html__( 'GBL: Social Widget', 'glaze-blog-lite' ),   // Widget Name
                array(
                    'description' => esc_html__( 'Displays social links.', 'glaze-blog-lite' ), 
                )
            );
                    ...
                    <div class="social-icons">
                        <ul class="social-icons-list">
                            ...
                            if( !empty( $facebook ) ) :
                                ?>
                                <li>
                                    <a class="tool-tip" data-tippy-content="<?php esc_attr_e( 'Follow on facebook', 'glaze-blog-lite' ); ?>" href="<?php echo esc_url( $facebook ); ?>"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                </li>
                                <?php
                            endif;
                            ...
                            if( !empty( $twitter ) ) :
                                ?>
                                <li>
                                    <a class="tool-tip" data-tippy-content="<?php esc_attr_e( 'Follow on twitter', 'glaze-blog-lite' ); ?>"  href="<?php echo esc_url( $twitter ); ?>"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                </li>
                                <?php
                            endif;
                            ...
                            if( !empty( $instagram ) ) :
                                ?>
                                <li>
                                    <a class="tool-tip" data-tippy-content="<?php esc_attr_e( 'Follow on instagram', 'glaze-blog-lite' ); ?>" href="<?php echo esc_url( $instagram ); ?>"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                                </li>
                                <?php
                            endif;
                            ...
                            if( !empty( $pinterest ) ) :
                                ?>
                                <li>
                                    <a class="tool-tip" data-tippy-content="<?php esc_attr_e( 'Follow on pinterest', 'glaze-blog-lite' ); ?>" href="<?php echo esc_url( $pinterest ); ?>"><i class="fa fa-pinterest" aria-hidden="true"></i></a>
                                </li>
                                <?php
                            endif;
                            ...
                            if( !empty( $youtube ) ) :
                                ?>
                                <li>
                                    <a class="tool-tip" data-tippy-content="<?php esc_attr_e( 'Subscribe at youtube', 'glaze-blog-lite' ); ?>" href="<?php echo esc_url( $youtube ); ?>"><i class="fa fa-youtube" aria-hidden="true"></i></a>
                                </li>
                                <?php
                            endif;
                            ...
                            if( !empty( $google_plus ) ) :
                                ?>
                                <li>
                                    <a class="tool-tip" data-tippy-content="<?php esc_attr_e( 'Follow on google+', 'glaze-blog-lite' ); ?>" href="<?php echo esc_url( $google_plus ); ?>"><i class="fa fa-google-plus" aria-hidden="true"></i></a>
                                </li>
                                <?php
                            endif;
                            ...
                            if( !empty( $linkedin ) ) :
                                ?>
                                <li>
                                    <a class="tool-tip" data-tippy-content="<?php esc_attr_e( 'Connect on linkedin', 'glaze-blog-lite' ); ?>" href="<?php echo esc_url( $linkedin ); ?>"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                                </li>
                                <?php
                            endif;
                            ...
                            if( !empty( $vk ) ) :
                                ?>
                                <li>
                                    <a class="tool-tip" data-tippy-content="<?php esc_attr_e( 'Follow on vk', 'glaze-blog-lite' ); ?>" href="<?php echo esc_url( $vk ); ?>"><i class="fa fa-vk" aria-hidden="true"></i></a>
                                </li>
                                <?php
                            endif;
                            ?>
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>">
                    <strong><?php esc_html_e( 'Facebook Link', 'glaze-blog-lite' ); ?></strong>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>">
                    <strong><?php esc_html_e( 'Twitter Link', 'glaze-blog-lite' ); ?></strong>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>">
                    <strong><?php esc_html_e( 'Instagram Link', 'glaze-blog-lite' ); ?></strong>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'pinterest' ) ); ?>">
                    <strong><?php esc_html_e( 'Pinterest Link', 'glaze-blog-lite' ); ?></strong>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'youtube' ) ); ?>">
                    <strong><?php esc_html_e( 'Youtube Link', 'glaze-blog-lite' ); ?></strong>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'google_plus' ) ); ?>">
                    <strong><?php esc_html_e( 'Google Plus Link', 'glaze-blog-lite' ); ?></strong>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>">
                    <strong><?php esc_html_e( 'linkedin Link', 'glaze-blog-lite' ); ?></strong>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'vk' ) ); ?>">
                    <strong><?php esc_html_e( 'VK Link', 'glaze-blog-lite' ); ?></strong>
                </label>
