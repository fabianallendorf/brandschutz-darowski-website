                        ...
                        <main id="main" class="site-main">
                            <div class="error-404-page-entry">
                                <div class="error-404-head">
                                    <h2><?php esc_html_e( '404', 'glaze-blog-lite' ); ?></h2>
                                </div><!-- .error-404-head -->
                                <div class="error-404-message">
                                    <p><?php esc_html_e( 'Oops! That page can&rsquo;t be found.', 'glaze-blog-lite' ); ?></p>
                                </div><!-- . error-404-message -->
                                <div class="error-404-body">
                                    <p><?php esc_html_e( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'glaze-blog-lite' ); ?></p>
